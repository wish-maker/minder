...
try:
    ...
    logging.warning("asyncpg not installed. PostgreSQL persistence will be disabled.")
...
PG_PORT = "5432"
PG_USER = "minder"
PG_PASSWORD = ""  # Will use environment variable
PG_DATABASE = "minder"
...
async def get_pg_connection():
    ...
    if pg_pool is None:
        ...
        pg_password = __import__('os').getenv("POSTGRES_PASSWORD", "")
