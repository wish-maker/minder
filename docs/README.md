...
**Services:** 32 containers defined; `setup.sh install` seeds the **standard** bundle profile (core + inference + rag + chat), monitoring/graph-rag/voice opt-in (`--profile full` = all 32); 3 have no healthcheck by design
