# `setup.sh` bash → Python port — history, gate methodology, and completion status

> Moved here from `scripts/setup/README.md` (2026-08-08) — this is a migration/status
> record (issue #7), not day-to-day usage documentation. For how to actually use the
