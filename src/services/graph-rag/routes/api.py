...
async def extract_entities_handler(request: EntityExtractionRequest) -> EntityExtractionResponse:
...
async def construct_knowledge_graph_handler(request: KnowledgeGraphRequest) -> KnowledgeGraphResponse:
...
async def retrieve_with_graph_handler(request: GraphRetrievalRequest) -> GraphRetrievalResponse:
    ...
    try:
        ...
        query_entities = [e["text"] for e in extraction_result["entities"]]
        related_entities = await graph_retriever.find_related_entities(
...
async def get_entity_context_handler(request: EntityContextRequest) -> EntityContextResponse:
